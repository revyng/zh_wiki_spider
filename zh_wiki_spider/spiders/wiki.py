...
from zh_wiki_spider.items import ContentItem
from zh_wiki_spider.queue import Queue
import time
from zh_wiki_spider.langconv import *
from zh_wiki_spider.filter_words import filter_url
...
class WiKiSpider(scrapy.Spider):
    ...
    custom_settings = {
        'ITEM_PIPELINES': {'zh_wiki_spider.pipelines.WikiPipeline': 800}
    }
